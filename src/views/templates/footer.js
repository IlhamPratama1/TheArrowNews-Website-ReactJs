...
export default function Footer() {
    ...
    return(
        ...
        <div className="w-full bg-black lg:px-32">
            <div className="lg:flex p-12 justify-between">
                <div className="flex space-x-16">
                    <img className="w-44 h-12" src="/static/images/logo.png" alt="logo" />
                    <div className="flex space-x-12">
                        <div className="space-y-4">
                            <h1 className="font-bold font-oswald uppercase text-yellow text-2xl">About</h1>
                            <div className="text-white text-lg font-cooper uppercase space-y-1">
                        ...
                        <div className="space-y-4">
                            <h1 className="font-bold font-oswald uppercase text-yellow text-2xl">Social</h1>
                            <div className="text-white text-lg font-cooper uppercase space-y-1">
                ...
                <form className="space-y-2">
                    <label className="text-white font-cooper uppercase font-bold text-lg">Subscribe now</label>
